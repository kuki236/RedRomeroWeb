...
// Sidebar Navigation Items (Same as AdminDashboard)
const navItems = [
    { header: 'General' },
    ...
    { text: 'Users', icon: <Group />, link: '/admin/usuarios', active: true }, // Active Item
    { header: 'Sistema' },
...
// --- DUMMY DATA ---
const initialUsers = [
    { id: 1, name: 'Alex Johnson', email: 'alex.j@redromero.org', role: 'Admin', status: 'Active' },
    { id: 2, name: 'Maria Garcia', email: 'maria.g@redromero.org', role: 'Employee', status: 'Active' },
    { id: 3, name: 'Sam Chen', email: 'sam.c@redromero.org', role: 'Volunteer', status: 'Inactive' },
    { id: 4, name: 'Priya Patel', email: 'priya.p@redromero.org', role: 'Representative', status: 'Active' },
    { id: 5, name: 'John Doe', email: 'john.d@redromero.org', role: 'Employee', status: 'Active' },
];
...
export default function UserManagement() {
    ...
    const handleSaveUser = () => {
        // Here you would call the API to save/update
        ...
        <Box sx={{ display: 'flex', width: '100vw', height: '100vh', overflow: 'hidden', bgcolor: '#F8F9FA' }}>
            ...
            >
                ...
                <Box component="form" display="flex" flexDirection="column" gap={3}>
                    ...
                    {/* Removed "Link to Employee/Volunteer" section as requested */}
